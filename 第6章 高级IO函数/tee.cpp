...
int main(int argc, char* argv[]) {
    ...
    ret = splice(STDOUT_FILENO, nullptr, pipefd_stdout[1], nullptr, 32768, SPLICE_F_MORE | SPLICE_F_MOVE);
    assert(ret != -1);
    ...
    ret = splice(pipefd_file[0], nullptr, filefd, nullptr, 32786, SPLICE_F_MORE | SPLICE_F_MOVE);
    assert(ret != -1);
